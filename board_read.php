  ...
  <body>
    ...
    <section>
     ...
     <div class="view_btn">
             ...
             <button class="view_btn1" onclick="location.href='board_modify_form.php?num=<?=$num?>'">수정</button>
             <button class="view_btn1" onclick="location.href='board_delete.php?num=<?=$num?>'">삭제</button>
           <?php } ?>
             <?php if($userid == 'admin'){ ?>
             <button class="view_btn1" onclick="location.href='admin_reply.php?num=<?=$num?>'">답변</button>
           <?php } ?>
           </div>
