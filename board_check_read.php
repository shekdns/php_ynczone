    ...
    <section>
      ...
      <div id="find_position">
        <div id="find_text">
          ...
          <div class="find">
            <form method="post" action="board_check.php?num=<?=$num?>" name="check_form">
              <h1><div style="font-size:20px; padding-bottom:20px; font-weight:bold;">이글은 비밀글입니다. 비밀번호를 입력해주세요
