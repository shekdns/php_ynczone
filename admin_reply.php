  ...
  <body>
    ...
    <section>
      <div id="write_position">
        ...
        <div id="write_text">
          <form method = "post" action = "admin_reply_input.php?num=<?=$num?>" enctype="multipart/form-data" name="write_form">
          ...
          <table class = "table2">
                  <tr>
                  <td>작성자</td>
                  <td><input type="text" name ="name" size=20 value="관리자" readonly> </td>
                  </tr>

                  <tr>
                  <td>제목</td>
                  <td><input type = "text" name = "title" size=60 value="답변드립니다!!" readonly></td>
                  </tr>
                  ...
                  <tr>
                  <td>비밀번호</td>
                  <td><input type = "password" name = "pass" size=10 maxlength=10 value="<?=$u_pass?>" readonly></td>
