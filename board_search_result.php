  ...
  <body>
    ...
    <section>
      ...
      <div id="board_area">
       ...
       <?php
        ...
        $search = $_GET["search"];
         ...
         $sql = "select * from uboard where name like '%$search%'";

         }if($b_cate =='제목'){

           $sql = "select * from uboard where title like '%$search%'";
     ...
     <div id ="board_serch_box">
       <form name="board_search_form" action="board_search_result.php?b_cate=<?=$b_cate?>&search=<?=$search?>" method="get">
           <select name="b_cate">
    ...
    <ul id="page_num">
      ...
      <?php
        ...
        {
          $new_page = $page-1;
          echo "<li><a href='board_search_result.php?page=$new_page&p_cate=$b_cate&search=$search'>◀ 이전</a> </li>";
        }
        else
          echo "<li>&nbsp;</li>";
          ...
          for ($i=1; $i<=$total_page; $i++){
            ...
            echo "<li><a href='board_search_result.php?page=$i&p_cate=$b_cate&search=$search'> $i </a><li>";
            }
          }
          if ($total_page>=2 && $page != $total_page)
          {
          $new_page = $page+1;
          echo "<li> <a href='board_search_result.php?page=$new_page&p_cate=$b_cate&search=$search'>다음 ▶</a> </li>";
        }
        else
          echo "<li>&nbsp;</li>";
      ?>
